    ...
    <div class="py-4 admin-page-info">
                        ...
                        <div class="btn-group">
                            <div class="dropdown me-1">
                                ...
                                <div class="dynamic-pagination dropdown-menu dropdown-menu-end pb-0">
                                    ...
                                    <a class="dropdown-item {{ Request::is('*/perPage/10') ? 'active' : '' }} {{ Request::is('admin/messeges') ? 'active' : '' }}"
                                        href="{{ route('admin.messeges.perPage', 10) }}"> 10 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/30') ? 'active' : '' }}"
                                        href="{{ route('admin.messeges.perPage', 30) }}"> 30 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/50') ? 'active' : '' }}"
                                        href="{{ route('admin.messeges.perPage', 50) }}"> 50 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/100') ? 'active' : '' }}"
                                        href="{{ route('admin.messeges.perPage', 100) }}"> 100 </a>
        ...
        @else
            ...
            <div class="card card-body shadow border-0 table-wrapper table-responsive">
                ...
                <!----------- multi Action ------------->
                <form id="multi-action-form" action="{{ route('admin.messeges.multiAction') }}" method="POST">
                    <div class="pb-3">
                    ...
                    <table class="table messege-table table-hover align-items-center index-table">
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom">Messege</th>
                        ...
                        <tbody>
                            @foreach ($messeges as $messege)
                                <tr class="{{$messege->as_read == '0' ? 'not_seen' : '' }} ">
                                    <td>
                                        <div class="form-check dashboard-check">
                                            <input name="id[]" value="{{ $messege->id }}"
                    ...
                    <div
                        ...
                        <div class="d-flex justify-content-center">
                            {{ $messeges->withQueryString()->onEachSide(0)->links() }}
                        </div>
                        <div class="fw-normal small mt-4 mt-lg-0">
                            Showing <b>{{ $messeges->firstItem() }}</b> to <b>{{ $messeges->lastItem() }}</b>
                            of total <b>{{ $messeges->total() }}</b> entries
                        </div>
                    </div>
                </form>
            </div>
