                ...
                <div class="row">
                    <div class="col-12 mb-4">
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <form action="{{ route('admin.orders.update' , $order->id) }}" class="edit-form" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="text" name="address" id="address"
                                                ...
                                                value="{{ $order->address }}" aria-describedby="emailHelp"
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="text" name="phone" id="phone"
                                                ...
                                                value="{{ $order->phone }}" aria-describedby="emailHelp"
                                                placeholder="Type Prescription Title..." autocomplete="nope" required/>
                                            @error('phone')
                                                <small class="form-text text-danger">{{ $message }}</small>
                                            @enderror
                                                                ...
                                                                <div class="col-6">
                                                                    <select name="product_id[]" id="product_id" class="form-control @error('product_id') is-invalid @enderror @error('product_id.*') is-invalid @enderror " required>
                                                                        @foreach ( $products as $product )
                                                                            <option value="{{$product->id}}" {{ $product->id == $product_id ? "selected" : "" }} >{{$product->title}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="col-3">
                                                                    <input type="number" class="form-control  @error('quantity') is-invalid @enderror @error('quantity.*') is-invalid @enderror " value="{{$quantity}}" name="quantity[]" id="quantity" placeholder="Quantity" required/>
                                                                </div>
                                                                <div class="col-3">
                                                                    <!---------- Buttons ----------->
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <select class="form-select form-control @error('status') is-invalid @enderror" name="status" id="status"  aria-label="Default select example" required>
                                                ...
                                                <option value="3" {{ $order->status == '3' ? "selected" : "" }}> En Route </option>
