...
@section('content')
    <div class="py-4 admin-page-info">
        ...
        <div class="table-settings mb-4">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-9 col-lg-8 d-md-flex">
                    <form action="{{ route('admin.prescription_orders.search') }}" method="POST" class="input-group me-2 me-lg-3 fmxw-300">
                        ...
                        <input type="email" name="search" class="form-control @error('search') is-invalid @enderror"
                            placeholder="Search orders by user email"  value='{{ Request::input('search') }}' autocomplete="off" maxlength="55" required/>
                        @error('search')
                        ...
                        <div class="btn-group">
                            <div class="dropdown me-1">
                                ...
                                <div class="dynamic-pagination dropdown-menu dropdown-menu-end pb-0">
                                    ...
                                    <a class="dropdown-item {{ Request::is('*/perPage/10') ? 'active' : '' }} {{ Request::is('admin/prescription_orders') ? 'active' : '' }}"
                                        href="{{ route('admin.prescription_orders.perPage', 10) }}"> 10 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/30') ? 'active' : '' }}"
                                        href="{{ route('admin.prescription_orders.perPage', 30) }}"> 30 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/50') ? 'active' : '' }}"
                                        href="{{ route('admin.prescription_orders.perPage', 50) }}"> 50 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/100') ? 'active' : '' }}"
                                        href="{{ route('admin.prescription_orders.perPage', 100) }}"> 100 </a>
        ...
        @if ($prescription_orders->isEmpty())
            <!----------- No Data ------------->
        ...
        @else
            ...
            <div class="card card-body shadow border-0 table-wrapper table-responsive">
                ...
                <!----------- multi Action ------------->
                <form id="multi-action-form" action="{{ route('admin.prescription_orders.multiAction') }}" method="POST">
                    <div class="pb-3">
                    ...
                    <table class="table prescription_order-table table-hover align-items-center index-table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($prescription_orders as $prescription_order)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.prescription_orders.show', $prescription_order->id) }}" class="d-flex align-items-center">
                                            <div class="d-block index-table-img">
                                                <img src="{{ asset("images/prescriptions/".$prescription_order->prescription->img) }}" height="50" alt="prescription_order_img">
                                            </div>
                                        </a>
                                    </td>
                                    <td><span class="fw-normal"> <a href="{{ route('admin.users.show',$prescription_order->user->id) }}" class="user-link"> {{ $prescription_order->user->name }} </a> </span></td>
                                    <td>
                                    ...
                                    <td class="actions">
                                        <a href="{{ route('admin.prescription_orders.show', $prescription_order->id) }}"
                                            class="text-tertiary"> <i class="fa-solid fa-eye fa-lg"></i> </a>
                                        <a href="{{ route('admin.prescription_orders.edit', $prescription_order->id) }}"
                                            class="text-info"> <i class="fa-solid fa-pen-to-square fa-lg"></i> </a>
                                        <a href="{{ route('admin.prescription_orders.destroy', $prescription_order->id) }}"
                    ...
                    <div
                        ...
                        <div class="d-flex justify-content-center">
                            {{ $prescription_orders->withQueryString()->onEachSide(0)->links() }}
                        </div>
                        <div class="fw-normal small mt-4 mt-lg-0">
                            Showing <b>{{ $prescription_orders->firstItem() }}</b> to <b>{{ $prescription_orders->lastItem() }}</b>
                            of total <b>{{ $prescription_orders->total() }}</b> entries
                        </div>
                    </div>
                </form>
            </div>
