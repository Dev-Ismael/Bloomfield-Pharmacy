                ...
                <div class="row">
                    <div class="col-12 mb-4">
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <form action="{{ route('admin.products.update' , $product->id) }}" class="edit-form" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="text" name="title" id="title"
                                                ...
                                                value="{{ $product->title }}" aria-describedby="emailHelp"
                                                placeholder="Type Sub product Title..." autocomplete="nope"  required/>
                                            @error('title')
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <select class="form-select form-control @error('subcategory_id') is-invalid @enderror" name="subcategory_id" id="subcategory_id"  aria-label="Default select example" required>
                                                ...
                                                @foreach ( $subcategories as $subcategory )
                                                    <option value="{{ $subcategory->id }}"  {{ $subcategory->id == $product->subcategory->id ? "selected" : "" }} >{{ $subcategory->title }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="number" name="price" id="price"
                                                ...
                                                value="{{ $product->price }}" aria-describedby="emailHelp"
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="number" name="quantity" id="quantity"
                                                ...
                                                value="{{ $product->quantity }}" aria-describedby="emailHelp"
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <select class="form-select form-control @error('has_offer') is-invalid @enderror" name="has_offer" id="has_offer"  aria-label="Default select example" required>
                                                ...
                                                <option value="0" {{ $product->has_offer == '0' ? "selected" : "" }}> No </option>
                                                <option value="1" {{ $product->has_offer == '1' ? "selected" : "" }}> Yes </option>
                                            </select>
                                            @error('has_offer')
                                                <small class="form-text text-danger">{{$message }}</small> 
                                            @enderror
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="number" name="offer_percentage" id="offer_percentage"
                                                ...
                                                value="{{ $product->offer_percentage }}" aria-describedby="emailHelp"
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="text" name="brand" id="brand"
                                                ...
                                                value="{{ $product->brand }}" aria-describedby="emailHelp"
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="text" name="measurement" id="measurement"
                                                ...
                                                value="{{ $product->measurement }}" aria-describedby="emailHelp"
                                        ...
                                        <div class="mb-3 input-content">
                                            <label for="img" class="form-label d-flex align-items-center"> 
                                                ...
                                                <div class="show-img-container">
                                                    <a href="{{ asset("images/products/".$product->img) }}"  target="_blank">
                                                        <img src="{{ asset("images/products/".$product->img) }}" alt="product-img">
                                                    </a>
                                                </div>
                                            </label> 
