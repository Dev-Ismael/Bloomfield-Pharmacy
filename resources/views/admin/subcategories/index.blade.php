    ...
    <div class="py-4 admin-page-info">
                ...
                <div class="col-9 col-lg-8 d-md-flex">
                    <form action="{{ route('admin.subcategories.search') }}" method="POST"
                        ...
                        <input type="text" name="search" class="form-control @error('search') is-invalid @enderror"
                            placeholder="Search sub categories by title"  value='{{ Request::input('search') }}' autocomplete="off" maxlength="55" required/>
                        @error('search')
                        ...
                        <div class="btn-group">
                            <div class="dropdown me-1">
                                ...
                                <div class="dynamic-pagination dropdown-menu dropdown-menu-end pb-0">
                                    ...
                                    <a class="dropdown-item {{ Request::is('*/perPage/10') ? 'active' : '' }} {{ Request::is('admin/subcategories') ? 'active' : '' }}"
                                        href="{{ route('admin.subcategories.perPage', 10) }}"> 10 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/30') ? 'active' : '' }}"
                                        href="{{ route('admin.subcategories.perPage', 30) }}"> 30 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/50') ? 'active' : '' }}"
                                        href="{{ route('admin.subcategories.perPage', 50) }}"> 50 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/100') ? 'active' : '' }}"
                                        href="{{ route('admin.subcategories.perPage', 100) }}"> 100 </a>
        ...
        @else
            ...
            <div class="card card-body shadow border-0 table-wrapper table-responsive">
                ...
                <!----------- multi Action ------------->
                <form id="multi-action-form" action="{{ route('admin.subcategories.multiAction') }}" method="POST">
                    <div class="pb-3">
                    ...
                    <table class="table subcategory-table table-hover align-items-center index-table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($subcategories as $subcategory)
                                <tr>
                                    ...
                                    <td><span class="fw-normal">{{ $subcategory->title }}</span></td>
                                    <td><span class="fw-normal">{{ $subcategory->category->title }}</span></td>
                                    <td><span class="fw-normal">{{ $subcategory->created_at }}</span></td>
                                    <td class="actions">
                    ...
                    <div
                        ...
                        <div class="d-flex justify-content-center">
                            {{ $subcategories->withQueryString()->onEachSide(0)->links() }}
                        </div>
                        <div class="fw-normal small mt-4 mt-lg-0">
                            Showing <b>{{ $subcategories->firstItem() }}</b> to <b>{{ $subcategories->lastItem() }}</b>
                            of total <b>{{ $subcategories->total() }}</b> entries
                        </div>
                    </div>
                </form>
            </div>
