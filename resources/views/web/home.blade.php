        ...
        <div class="container remove-padding services-main section text-center">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 text-center service-item">
                ...
                <p>Now you can shop online, select all what you need from the pharmacy through our online store on web or on
                    mobile app., <span id="dots">...</span><span id="more">and we will deliver it to you directly from our
                        diffuse branches.<br>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 text-center service-item">
                ...
                <p>Blood pressure, sugar, and weight… etc. results are important indicators on your health status and are
                    necessary when pursuing chronic<span id="dots2">...</span><span id="more2"> treatment or go to a new
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 text-center service-item">
                ...
                <p>From now and then you will not lose a prescription again!<br> You can keep all your prescriptions <span
                        id="dots3">...</span><span id="more3"> you ordered from Fouda pharmacies or through our website or
