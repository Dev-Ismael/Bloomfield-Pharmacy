        ...
        <div class="section container remove-padding text-center faq-main section-h2 margin-t-100 ">
            <h1 class="title text-bloder"> <i class="fa-solid fa-dolly"></i> My Orders </h1>
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="card mt-2">
                        <div class="card-header text-left" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true">     
                            <span class="title text-left"> ORDER ID <span
                                class="text-primary font-weight-bold">#95847635</span> </span>
                                                    ...
                                                    <div class="card-body p-5">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center mb-5">
                                                            ...
                                                            <div>
                                                                <p class="mb-0">Expected Arrival <span
                                                                        class="pl-2 font-weight-bold">01/08/2022</span></p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-lg-flex align-items-center process-info">
                                                                <i class="fas fa-clipboard-list fa-3x me-lg-4 mb-3 mb-lg-0 pr-3"></i>
                    ...
                    <div class="card mt-2">
                        <div class="card-header text-left collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false">     
                            <span class="title text-left"> ORDER ID <span
                                class="text-primary font-weight-bold">#95847635</span> </span>
                            <span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
                        </div>
                    ...
                    <div class="card mt-2">
                        <div class="card-header text-left collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false">
                            <span class="title text-left"> ORDER ID <span
                                class="text-primary font-weight-bold">#95847635</span> </span>
                            <span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
                        </div>
