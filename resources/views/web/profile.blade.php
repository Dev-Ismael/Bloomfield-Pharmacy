                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="p-3 py-5">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group text-left">
                                    <label for="lastName" class="text-black">Phone </label>
                                    <input type="text" class="form-control" id="lastName" placeholder="Type Phone Number...">
                                </div>
                                <div class="col-md-6 form-group text-left">
                                    <label for="lastName" class="text-black"> Second Phone (optional) </label>
                                    <input type="text" class="form-control" id="lastName" placeholder="Type Phone Number...">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-group text-left">
                                    <label for="email2" class="text-black">Second Email (optional) </label>
                                    <input type="text" class="form-control" id="email2"  placeholder="Type Email Address...">
                                </div>
                                <div class="col-md-6 form-group text-left">
                                    <label for="state" class="text-black"> State/Region </label>
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group text-left">
                                    <label for="address2" class="text-black"> Second Address (optional) </label>
                                    <input type="text" class="form-control" id="address2" placeholder="Type Address Details...">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 form-group text-left">
                                    <label for="address3" class="text-black"> Third Address (optional) </label>
